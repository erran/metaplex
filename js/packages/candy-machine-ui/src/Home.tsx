...
const Home = (props: HomeProps) => {
  ...
  // TODO: Replace with actual candy machine addresses - move the JSX inside the candyMachineAddresses.map into a separate component.
  const candyMachineAddresses = [1, 2, 3];
  return (
    <Container style={{ marginTop: 100 }}>
      <Container maxWidth="xs" style={{ position: 'relative' }}>
        <Grid container maxWidth="xs" style={{ position: 'relative' }} spacing={2}>
          {!wallet.connected && (
              <Grid item xs={12}>
                <Paper
                  style={{
          ...
          {wallet.connected && candyMachineAddresses.map(x => (
